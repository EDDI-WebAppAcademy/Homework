...
public class FirstController {
    ...
    public String whatTimeIsIt (Locale locale, Model model) {
        ...
        // model.addAttribute()는 HashMap처럼 특정 키 값이 밸류 값을 맵핑 시키는 것이라 봐도 무방함.
        // 즉 serTime에 formattedDate인 형식을 갖춘 날자가 맵핑됨.
        // model.addAttribute()를 하면 HTML에서 Thymeleaf 등을 통해서 정보를 읽을 수 있음.
        model.addAttribute("servTime", formattedDate);
        //resources/templates에 있는 basic/first/whatTimeIsIt.html을 리턴시키게 됨
