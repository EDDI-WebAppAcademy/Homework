    ...
    <h1>{{ testMsg }}</h1>
      ...
      <table border="1" v-if="inventoryView">
        <tr>
          ...
          <th align="center" width="120">아이템명</th>
          <th align="center" width="320">아이템 설명</th>
          <th align="center" width="40">착용</th>
        </tr>
        <tr v-for="(itemList, idx) in myInventory" :key="idx">
          <th align="center" width="40">{{ idx }}</th>
...
export default {
  ...
  methods: {
    ...
    calcUseList() { // 물품 이름들과 효과를 어떻게 맞춰야 될지를 잘 모르겠음...
      let i
      let j
      ...
      alert("착용했습니다") // 그다음부터 물품 착용 효과 메소드를 만들어야 되는건 알고 있는데 여기서부터 꼬임;;
      this.inventoryList = []
    },
