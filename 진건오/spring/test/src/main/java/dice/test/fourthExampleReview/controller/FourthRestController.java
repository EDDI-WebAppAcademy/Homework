package dice.test.fourthExampleReview.controller;

import dice.test.fourthExampleReview.entity.Series;
...
public class FourthRestController {
    ...
    public String findSpecificSeries() {
        log.info("피보나치 수열을 검색합니다.");

        Series series = new Series(FIBONACCI, EXAMPLE2_DATA);
        return "피보나치의 수열의" + EXAMPLE2_DATA + "번째 항은" + series.findSeriesNum();
    }
    ...
    public String findCustomSeries() {
        ...
        Series series = new Series(FIBONACCI, EXAMPLE3_DATA);
        return "커스텀 수열의" + EXAMPLE3_DATA + "번째 항은" + series.findSeriesNum();
    }
}
