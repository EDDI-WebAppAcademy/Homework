...
public class QuestionBank {
    ...
    public int sumFourTimesNum(){
        ...
        return sumFourTimesNum.FourTimesNum(); // 결과 1700
    }

    @ResponseBody
    @GetMapping("/Question8")
    public ArrayList printRanNumMultiple(){
