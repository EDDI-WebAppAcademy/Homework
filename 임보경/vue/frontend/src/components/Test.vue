...
export default {
  ...
  data() {
    return {
      ...
      shopListValue: [],
      itemBooks: [
        { id: 1, name: 'HP 포션 I', price: 50, effect: { description: 'hp 200 회복', amount: 200 }},
        { id: 2,  name: 'HP 포션 II', price: 200, effect: { description: 'hp 600 회복', amount: 600 }},
        { id: 3,  name: '낡은 검', price: 50000, effect: { description: '무기 공격력 100', atk: 100 }},
        { id: 4,  name: '검', price: 50000000, effect: { description: '무기 공격력 200', atk: 200 }},
        { id: 5,  name: '강철 검', price: 150000000, effect: { description: '무기 공격력 300', atk: 300 }},
      ],
      inventory: [
      ],
      equipments: [
      ...
      let id
        ...
        for (let j = 0; j < this.itemBooks.length; j++) {
          if (this.inventory[index].name === this.itemBooks[j].name) {
            id = this.itemBooks[j].id

            if (id > 2) {
              this.equipments.push(this.itemBooks[j])
              this.characterStatus.atk += this.itemBooks[j].effect.atk
