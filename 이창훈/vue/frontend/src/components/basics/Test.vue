<template>
  <div>
    ...
    <button v-on:click="equipItem()">아이템 사용</button>
  ...
  data() {
    return {
      ...
      itemBooks: [
        ...
        { name: '낡은 검', price: 50000, effect: { description: '무기 공격력 100', atk: 100 }},
      ...
      monsterBooks: [
        ...
        { monsterId: 20, name: '드레이크', hp: 20000, exp: 50000, dropMoney: 50000 },
        { monsterId: 21, name: '죽음의 군주', hp: 1000000, exp: 2000000, dropMoney: 1000000 },
        { monsterId: 9999, name: '하이퍼 메탈 슬라임', hp: 1000, exp: 50000000, dropMoney: 10000000 }
      ],
      monsterLists: [
        { id: 1, name: '슬라임', hp: 50 },
