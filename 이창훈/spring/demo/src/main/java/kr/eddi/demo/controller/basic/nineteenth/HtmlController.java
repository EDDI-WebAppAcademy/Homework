...
public class HtmlController {
    ...
    @GetMapping("/table-test-practice")
    public String tableTestPractice() {
        log.info("table-test-practice");

        return "/basic/nineteenth/table-test-practice";
    }
    ...
    public String example() {
        ...
        return "/basic/nineteenth/example";
    }
}
