...
import kr.eddi.demo.controller.rpgPractice.request.Items;
import kr.eddi.demo.controller.rpgPractice.request.RequestBuyItem;
import kr.eddi.demo.entity.rpgPractice.ShopItems;
...
public class RpgItemController {
    ...
    public void buildRandomShopList (List<ShopItems> randomShopLists) {
        ...
        for (int i = 0; i < 10; i++) {
            ShopItems oneThing = allShopLists.get(CustomRandom.makeCustomRandom(0, everyItemSize - 1));
